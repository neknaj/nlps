        ...
        while (i < this.code.length) {
            {
                if (false) { }
                    ...
                    state = 7;
                else if (state == 3 && (((tc[i] == " ")) || ((tc[i] == ":")) || ((tc[i] == ",")) || ((tc[i] == ",")) || ((tc[i] == ";"))))
                    state = 3;
                else if (state == 3 && (((tc[i] == "!")) || ((tc[i] == "(")) || ((tc[i] == ")")) || ((tc[i] == "{")) || ((tc[i] == "}"))))
                    state = 4;
                    ...
                    state = 7;
                else if (state == 4 && (((tc[i] == " ")) || ((tc[i] == ":")) || ((tc[i] == ",")) || ((tc[i] == ",")) || ((tc[i] == ";"))))
                    state = 3;
                else if (state == 4 && (((tc[i] == "!")) || ((tc[i] == "(")) || ((tc[i] == ")")) || ((tc[i] == "{")) || ((tc[i] == "}"))))
                    state = 4;
                    ...
                    state = 7;
                else if (state == 7 && (((tc[i] == " ")) || ((tc[i] == ":")) || ((tc[i] == ",")) || ((tc[i] == ",")) || ((tc[i] == ";"))))
                    state = 3;
                else if (state == 7 && (((tc[i] == "!")) || ((tc[i] == "(")) || ((tc[i] == ")")) || ((tc[i] == "{")) || ((tc[i] == "}"))))
                    state = 4;
                    ...
                    state = 2;
                else if (state == 10 && (((tc[i] == " ")) || ((tc[i] == ":")) || ((tc[i] == ",")) || ((tc[i] == ",")) || ((tc[i] == ";"))))
                    state = 3;
                else if (state == 10 && (((tc[i] == "!")) || ((tc[i] == "(")) || ((tc[i] == ")")) || ((tc[i] == "{")) || ((tc[i] == "}"))))
                    state = 4;

        ...
        while (i<tar.length) {
            ...
            switch(state_copy){
                ...
                case 57:
                    ...
                    else if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="replace")) state=65;
                    else if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="ctrl")) state=66;
                    break;
                case 64:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=67;
                    break;
                case 67:
                    if ((tar[i].group=="token"||tar[i].group=="string")) state=68;
                    else if ((tar[i].group=="blank")) state=69;
                    break;
                case 69:
                ...
                case 70:
                    ...
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=72;
                    break;
                case 71:
                    if ((tar[i].group=="blank")) state=71;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=72;
                ...
                case 75:
                    ...
                    break;
                case 76:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=77;
                    break;
                case 77:
                ...
                case 78:
                    ...
                    break;
                case 79:
                    if ((tar[i].group=="split")&&(tar[i].val==";")) state=80;
                    break;
                case 80:
                    state=3;
                    break;
                ...
                case 81:
                    ...
                    else if ((tar[i].group=="special")&&(tar[i].val=="(")) state=83;
                    break;
                case 82:
                    if ((tar[i].group=="blank")) state=82;
                    else if ((tar[i].group=="special")&&(tar[i].val=="(")) state=83;
                ...
                case 85:
                    ...
                    break;
                case 86:
                    if ((tar[i].group=="blank")) state=87;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=88;
                    break;
                case 87:
                    if ((tar[i].group=="blank")) state=87;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=88;

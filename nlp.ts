class NLPtool {
    ...
    parse(): Object {
        ...
        while (i<tar.length) {
            ...
            switch(state_copy){
                case 1:
                    if ((tar[i].group=="special")&&(tar[i].val=="!")) state=3;
                    else if ((tar[i].group=="comment")) state=4;
                    else if ((tar[i].group=="blank")) state=5;
                    else if ((tar[i].group=="LF")) state=6;
                    break;
                case 4:
                    if ((tar[i].group=="note")) state=7;
                    else state=1;
                    break;
                case 7:
                    state=1;
                ...
                case 6:
                    ...
                    break;
                case 3:
                    if ((tar[i].group=="token")&&(tar[i].val=="include")) state=8;
                    else if ((tar[i].group=="token")&&(tar[i].val=="using")) state=9;
                    else if ((tar[i].group=="token")&&(tar[i].val=="replace")) state=10;
                    else if ((tar[i].group=="token")&&(tar[i].val=="global")) state=11;
                    else if ((tar[i].group=="token")&&(tar[i].val=="fn")) state=12;
                    break;
                case 8:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=13;
                    break;
                case 13:
                    if ((tar[i].group=="blank")) state=14;
                    else if ((tar[i].group=="token")) state=15;
                    break;
                case 14:
                    if ((tar[i].group=="blank")) state=14;
                    else if ((tar[i].group=="token")) state=15;
                ...
                case 17:
                    ...
                    else if ((tar[i].group=="token")) state=19;
                    break;
                case 18:
                    if ((tar[i].group=="blank")) state=18;
                    else if ((tar[i].group=="token")) state=19;
                ...
                case 21:
                    ...
                    else if ((tar[i].group=="token")) state=23;
                    break;
                case 22:
                    if ((tar[i].group=="blank")) state=22;
                    else if ((tar[i].group=="token")) state=23;
                ...
                case 24:
                    ...
                    else if ((tar[i].group=="token")) state=26;
                    break;
                case 25:
                    if ((tar[i].group=="blank")) state=25;
                    else if ((tar[i].group=="token")) state=26;
                ...
                case 28:
                    ...
                    else if ((tar[i].group=="token")) state=30;
                    break;
                case 29:
                    if ((tar[i].group=="blank")) state=29;
                    else if ((tar[i].group=="token")) state=30;
                ...
                case 31:
                    ...
                    else if ((tar[i].group=="token")) state=33;
                    break;
                case 32:
                    if ((tar[i].group=="blank")) state=32;
                    else if ((tar[i].group=="token")) state=33;
                ...
                case 35:
                    ...
                    else if ((tar[i].group=="token")) state=37;
                    break;
                case 36:
                    if ((tar[i].group=="blank")) state=36;
                    else if ((tar[i].group=="token")) state=37;
                ...
                case 37:
                    ...
                    else if ((tar[i].group=="special")&&(tar[i].val=="(")) state=39;
                    break;
                case 38:
                    if ((tar[i].group=="blank")) state=38;
                    else if ((tar[i].group=="special")&&(tar[i].val=="(")) state=39;
                ...
                case 39:
                    ...
                    else if ((tar[i].group=="token")) state=41;
                ...
                case 43:
                    ...
                    else if ((tar[i].group=="token")) state=45;
                    break;
                case 44:
                    if ((tar[i].group=="blank")) state=44;
                    else if ((tar[i].group=="token")) state=45;
                ...
                case 45:
                    ...
                    else if ((tar[i].group=="split")&&(tar[i].val==",")) state=47;
                    else if ((tar[i].group=="special")&&(tar[i].val==")")) state=42;
                    break;
                case 46:
                    if ((tar[i].group=="blank")) state=46;
                ...
                case 48:
                    ...
                    else if ((tar[i].group=="token")) state=50;
                    break;
                case 49:
                    if ((tar[i].group=="blank")) state=49;
                    else if ((tar[i].group=="token")) state=50;
                ...
                case 50:
                    ...
                    else if ((tar[i].group=="special")&&(tar[i].val=="{")) state=52;
                    break;
                case 51:
                    if ((tar[i].group=="blank")) state=51;
                    else if ((tar[i].group=="special")&&(tar[i].val=="{")) state=52;
                ...
                case 52:
                    ...
                    break;
                case 2:
                    if ((tar[i].group=="special")&&(tar[i].val=="!")) state=53;
                    else if ((tar[i].group=="comment")) state=54;
                    else if ((tar[i].group=="blank")) state=55;
                    else if ((tar[i].group=="LF")) state=56;
                    else if ((tar[i].group=="token")) state=57;
                    break;
                case 54:
                    if ((tar[i].group=="note")) state=58;
                    else state=2;
                    break;
                case 58:
                    state=2;
                ...
                case 56:
                    ...
                    break;
                case 57:
                    if ((tar[i].group=="blank")) state=59;
                    else if ((tar[i].group=="split")&&(tar[i].val==";")) state=60;
                    break;
                case 59:
                    if ((tar[i].group=="token")) state=57;
                    else if ((tar[i].group=="split")&&(tar[i].val==";")) state=60;
                    else if ((tar[i].group=="assign")&&(tar[i].val==":")) state=61;
                    break;
                case 61:
                    if ((tar[i].group=="assign")&&(tar[i].val==">")) state=62;
                    break;
                case 60:
                    state=2;
            }

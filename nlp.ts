        ...
        while (i<this.code.length) {
            {
                ...
                else if (state==21 &&(!(tc[i]==" "))&&(!(tc[i]==":"))) { throw this.tokenizeerror(`${sts[21]} => ${sts[19]}; !space&!colon`,i) }
                ...
                else if (state==30 &&(!(tc[i]==" "))&&(!(tc[i]==":"))) { throw this.tokenizeerror(`${sts[30]} => ${sts[28]}; !space&!colon`,i) }

        ...
        while (i<tar.length) {
            ...
            switch(state){
                ...
                case 36:
                    ...
                    else if ((tar[i].group=="split")&&(tar[i].val=="(")) state=38;
                    else state=0;
                    break;
                case 37:
                    if ((tar[i].group=="split")&&(tar[i].val==" ")) state=37;

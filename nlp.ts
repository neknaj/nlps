class NLPtool {
    ...
    parse(): Object {
        ...
        while (i<tar.length) {
            ...
            switch(state_copy){
                case 1:
                    if ((tar[i].group=="special")&&(tar[i].val=="!")) state=6;
                    else if ((tar[i].group=="comment")) state=7;
                    else if ((tar[i].group=="blank")) state=8;
                    else if ((tar[i].group=="LF")) state=9;
                    break;
                case 7:
                    if ((tar[i].group=="note")) state=10;
                    else state=1;
                    break;
                case 10:
                    state=1;
                ...
                case 9:
                    ...
                    break;
                case 6:
                    if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="include")) state=11;
                    else if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="using")) state=12;
                    else if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="replace")) state=13;
                    else if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="global")) state=14;
                    else if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="fn")) state=15;
                    break;
                case 11:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=16;
                    break;
                case 16:
                    if ((tar[i].group=="blank")) state=17;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=18;
                    break;
                case 17:
                    if ((tar[i].group=="blank")) state=17;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=18;
                ...
                case 40:
                    ...
                    else if ((tar[i].group=="special")&&(tar[i].val=="(")) state=42;
                    break;
                case 41:
                    if ((tar[i].group=="blank")) state=41;
                    else if ((tar[i].group=="special")&&(tar[i].val=="(")) state=42;
                ...
                case 43:
                    ...
                    break;
                case 44:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=46;
                    break;
                case 46:
                ...
                case 47:
                    ...
                    break;
                case 48:
                    if ((tar[i].group=="blank")) state=49;
                    else if ((tar[i].group=="split")&&(tar[i].val==",")) state=50;
                    else if ((tar[i].group=="special")&&(tar[i].val==")")) state=45;
                    break;
                case 49:
                    if ((tar[i].group=="blank")) state=49;
                ...
                case 50:
                    ...
                    break;
                case 45:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=51;
                    break;
                case 51:
                    if ((tar[i].group=="blank")) state=52;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=53;
                    break;
                case 52:
                    if ((tar[i].group=="blank")) state=52;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=53;
                    break;
                case 53:
                    if ((tar[i].group=="blank")) state=54;
                    else if ((tar[i].group=="special")&&(tar[i].val=="{")) state=55;
                    break;
                case 54:
                    if ((tar[i].group=="blank")) state=54;
                    else if ((tar[i].group=="special")&&(tar[i].val=="{")) state=55;
                ...
                case 3:
                    ...
                    break;
                case 2:
                    if ((tar[i].group=="special")&&(tar[i].val=="!")) state=56;
                    else if ((tar[i].group=="comment")) state=57;
                    else if ((tar[i].group=="blank")) state=58;
                    else if ((tar[i].group=="LF")) state=59;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=60;
                    else if ((depth==1)&&(tar[i].group=="special")&&(tar[i].val=="}")) state=4;
                    else if ((depth>1)&&(tar[i].group=="special")&&(tar[i].val=="}")&&(tar[i+1].val==";")) state=61;
                ...
                case 4:
                    if ((depth==0)) state=1;
                    else if ((depth>0)&&(depth==1)) state=2;
                    break;
                case 57:
                    if ((tar[i].group=="note")) state=62;
                    else state=2;
                    break;
                case 62:
                    state=2;
                ...
                case 59:
                    ...
                    break;
                case 56:
                    if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="local")) state=63;
                    else if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="ctrl")) state=64;
                    break;
                case 63:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=65;
                    break;
                case 65:
                    if ((tar[i].group=="token"||tar[i].group=="string")) state=66;
                    else if ((tar[i].group=="blank")) state=67;
                    break;
                case 67:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=67;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=66;
                    break;
                case 66:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=68;
                    break;
                case 68:
                    if ((tar[i].group=="blank")) state=69;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=70;
                    break;
                case 69:
                    if ((tar[i].group=="blank")) state=69;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=70;
                ...
                case 72:
                    ...
                    else if ((tar[i].group=="special")&&(tar[i].val=="(")) state=74;
                    break;
                case 73:
                    if ((tar[i].group=="blank")) state=73;
                    else if ((tar[i].group=="special")&&(tar[i].val=="(")) state=74;
                    break;
                case 74:
                    if ((tar[i].group=="blank")) state=75;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=76;
                    break;
                case 75:
                    if ((tar[i].group=="blank")) state=75;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=76;
                    else if ((tar[i].group=="special")&&(tar[i].val==")")) state=77;
                    break;
                case 76:
                    if ((tar[i].group=="blank")) state=75;
                    else if ((tar[i].group=="special")&&(tar[i].val==")")) state=77;
                    break;
                case 77:
                    if ((tar[i].group=="blank")) state=78;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=79;
                    break;
                case 78:
                    if ((tar[i].group=="blank")) state=78;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=79;
                    break;
                case 79:
                    if ((tar[i].group=="blank")) state=80;
                    else if ((tar[i].group=="special")&&(tar[i].val=="{")) state=81;
                    break;
                case 80:
                    if ((tar[i].group=="blank")) state=80;
                    else if ((tar[i].group=="special")&&(tar[i].val=="{")) state=81;
                ...
                case 60:
                    ...
                    else if ((tar[i].group=="split")&&(tar[i].val==";")) state=86;
                    break;
                case 85:
                    if ((tar[i].group=="token"||tar[i].group=="string")) state=60;
                    else if ((tar[i].group=="split")&&(tar[i].val==";")) state=86;
                    else if ((tar[i].group=="assign")) state=87;
                    break;
                case 87:
                ...
                case 88:
                    ...
                    else if ((tar[i].group=="special")&&(tar[i].val=="!")) state=90;
                    break;
                case 89:
                    if ((tar[i].group=="split")&&(tar[i].val==";")) state=86;
                    break;
                case 90:
                    if ((tar[i].group=="token"||tar[i].group=="string")&&(tar[i].val=="local")) state=91;
                    break;
                case 91:
                    if ((tar[i].group=="split")&&(tar[i].val==":")) state=92;
                    break;
                case 92:
                    if ((tar[i].group=="blank")) state=93;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=94;
                    break;
                case 93:
                ...
                case 94:
                    ...
                    break;
                case 95:
                    if ((tar[i].group=="blank")) state=96;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=97;
                    break;
                case 96:
                    if ((tar[i].group=="blank")) state=96;
                    else if ((tar[i].group=="token"||tar[i].group=="string")) state=97;
                    break;
                case 97:
                    if ((tar[i].group=="split")&&(tar[i].val==";")) state=98;
                    break;
                case 98:
                    state=2;
                    break;
